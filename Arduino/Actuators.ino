...
//Humidifier 35+-10
//Heat cable 25+-5
  t.setup(6,60,3);//Set temperature maximum variation around target
  t.setTarget(18); //Set heater target 

#ifdef HUMCONTROLLED
  //Controlled  humidifierversion
  h.setup(20,90,10);
h.setTarget(35); //Set humidifier target
#else
  ...
  //Heat cable
  tc.setup(10,60,3);
  tc.setTarget(25);    //Set heat Cable target
